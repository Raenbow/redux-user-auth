    ...
    render(){
        ...
        return(
            <form onSubmit={handleSubmit(this.handleSignUp.bind(this))}>
                ...
                <div className="row">
                    <Field className="col-6 offset-3" name="password" type="password" component={this.renderInputs} label="Password"/>
                </div>
                <div className="row">
                    <Field className="col-6 offset-3" name="confirmPassword" type="password" component={this.renderInputs} label="Confirm Password"/>
                </div>
                <div className="row">
